...
import io.github.ones1kk.assertion.core.feature.comparable.length.LengthComparableAssert;
 ...
 */
public interface ArrayAssertion<SELF, ACTUAL> extends IterableAssert<SELF, ACTUAL>, LengthComparableAssert<SELF, ACTUAL[]> {
}
