...
public class Shorts extends Objects<Short> implements DivisiblesAssertion<Short> {
     ...
     */
    @Override
    public void assertOdd(AssertionsInfo info, Short actual) {
     ...
     */
    @Override
    public void assertNotOdd(AssertionsInfo info, Short actual) {
     ...
     */
    @Override
    public void assertEven(AssertionsInfo info, Short actual) {
        if (DivisibleType.of(actual).isOdd()) {
     ...
     */
    @Override
    public void assertNotEven(AssertionsInfo info, Short actual) {
        if (DivisibleType.of(actual).isEven()) {
     ...
     */
    @Override
    public void assertPositive(AssertionsInfo info, Short actual) {
     ...
     */
    @Override
    public void assertNotPositive(AssertionsInfo info, Short actual) {
        if (comparable.isGreaterThan(actual, (short) 0)) {
     ...
     */
    @Override
    public void assertNegative(AssertionsInfo info, Short actual) {
        if (comparable.isGreaterThanOrEqualTo(actual, (short) 0)) {
     ...
     */
    @Override
    public void assertNotNegative(AssertionsInfo info, Short actual) {
     ...
     */
    @Override
    public void assertZero(AssertionsInfo info, Short actual) {
     ...
     */
    @Override
    public void assertNotZero(AssertionsInfo info, Short actual) {
     ...
     */
    @Override
    public void assertCloseTo(AssertionsInfo info, Short actual, Short expected, Offset<Short> offset) {
     ...
     */
    @Override
    public void assertCloseTo(AssertionsInfo info, Short actual, Short expected, Percentage<Short> percentage) {
     ...
     */
    @Override
    public void assertNotCloseTo(AssertionsInfo info, Short actual, Short expected, Offset<Short> offset) {
        if (offset.isOffset(actual, expected)) {
            setAssertClose(info, actual, offset);
        }
    }
     ...
     */
    @Override
    public void assertNotCloseTo(AssertionsInfo info, Short actual, Short expected, Percentage<Short> percentage) {
        if (percentage.isRange(actual, expected)) {
            setAssertClose(info, actual, percentage);
        }
    }
     ...
     */
    @Override
    public void assertLessThan(AssertionsInfo info, Short actual, Short expected) {
     ...
     */
    @Override
    public void assertLessThanOrEqualTo(AssertionsInfo info, Short actual, Short expected) {
     ...
     */
    @Override
    public void assertGreaterThan(AssertionsInfo info, Short actual, Short expected) {
     ...
     */
    @Override
    public void assertGreaterThanOrEqualTo(AssertionsInfo info, Short actual, Short expected) {
     ...
     */
    @Override
    public void assertBetween(AssertionsInfo info, Short actual, Short start, Short end) {
    ...
    private void setAssertClose(AssertionsInfo info, Short actual, Offset<Short> offset) {
        throw failures.failure(info, DataErrorMessage.shouldBeCloseTo(actual, offset.getBefore(actual), offset.getAfter(actual)));
    }

    private void setAssertClose(AssertionsInfo info, Short actual, Percentage<Short> percentage) {
