...
/**
 * <strong> The LocalDates class inherits {@link Objects} </strong>
 */
public final class LocalDates extends Objects<LocalDate> implements LocalDatesAssertion {
     ...
     */
    @Override
    public void assertBefore(AssertionsInfo info, LocalDate actual, LocalDate expected) {
     ...
     */
    @Override
    public void assertBeforeOrEqualTo(AssertionsInfo info, LocalDate actual, LocalDate expected) {
     ...
     */
    @Override
    public void assertAfter(AssertionsInfo info, LocalDate actual, LocalDate expected) {
