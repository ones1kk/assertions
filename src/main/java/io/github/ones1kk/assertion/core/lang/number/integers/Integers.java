...
public class Integers extends Objects<Integer> implements DivisiblesAssertion<Integer> {
     ...
     */
    @Override
    public void assertOdd(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertNotOdd(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertEven(AssertionsInfo info, Integer actual) {
        if (DivisibleType.of(actual).isOdd()) {
     ...
     */
    @Override
    public void assertNotEven(AssertionsInfo info, Integer actual) {
        if (DivisibleType.of(actual).isEven()) {
     ...
     */
    @Override
    public void assertNotPositive(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertNegative(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertNotNegative(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertZero(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertNotZero(AssertionsInfo info, Integer actual) {
     ...
     */
    @Override
    public void assertCloseTo(AssertionsInfo info, Integer actual, Integer expected, Offset<Integer> offset) {
     ...
     */
    @Override
    public void assertCloseTo(AssertionsInfo info, Integer actual, Integer expected, Percentage<Integer> percentage) {
     ...
     */
    @Override
    public void assertNotCloseTo(AssertionsInfo info, Integer actual, Integer expected, Offset<Integer> offset) {
        if (offset.isOffset(actual, expected)) {
            setAssertClose(info, actual, offset);
        }
    }
     ...
     */
    @Override
    public void assertNotCloseTo(AssertionsInfo info, Integer actual, Integer expected, Percentage<Integer> percentage) {
        if (percentage.isRange(actual, expected)) {
            setAssertClose(info, actual, percentage);
        }
    }
     ...
     */
    @Override
    public void assertLessThan(AssertionsInfo info, Integer actual, Integer expected) {
     ...
     */
    @Override
    public void assertLessThanOrEqualTo(AssertionsInfo info, Integer actual, Integer expected) {
     ...
     */
    @Override
    public void assertGreaterThan(AssertionsInfo info, Integer actual, Integer expected) {
     ...
     */
    @Override
    public void assertGreaterThanOrEqualTo(AssertionsInfo info, Integer actual, Integer expected) {
     ...
     */
    @Override
    public void assertBetween(AssertionsInfo info, Integer actual, Integer start, Integer end) {
    ...
    private void setAssertClose(AssertionsInfo info, Integer actual, Offset<Integer> offset) {
        throw failures.failure(info, DataErrorMessage.shouldBeCloseTo(actual, offset.getBefore(actual), offset.getAfter(actual)));
    }

    private void setAssertClose(AssertionsInfo info, Integer actual, Percentage<Integer> percentage) {
