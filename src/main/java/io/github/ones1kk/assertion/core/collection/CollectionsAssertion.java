...
import io.github.ones1kk.assertion.core.feature.iterable.collection.CollectionIterable;
 ...
 */
public interface CollectionsAssertion<ELEMENT> extends CollectionIterable<ELEMENT>, SizeComparable<Collection<? extends ELEMENT>> {
}
