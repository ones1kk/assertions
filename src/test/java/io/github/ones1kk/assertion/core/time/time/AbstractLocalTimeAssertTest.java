...
class AbstractLocalTimeAssertTest {
    ...
    class TestIsBefore {
        ...
        void testSuccess() throws Exception {
            // given
            LocalTime actual = LocalTime.of(1 ,1);
            LocalTime expected = LocalTime.of(2, 1);


            // when
            AbstractLocalTimeAssert asserts  = new LocalTimeAssert(actual);
        ...
        void testFail() throws Exception {
            // given
            LocalTime actual = LocalTime.of(2, 1);
            LocalTime expected = LocalTime.of(1 ,1);
