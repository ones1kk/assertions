...
class DefaultTextFormatterTest {
    ...
    void testPrintWithAllArgument() throws Exception {
        ...
        Formattable defaultTextFormatter = new DefaultTextFormatter();

        Description description = new Description(message);

        // when
        String result1 = defaultTextFormatter.format(message, actual, expected);
        String result2 = defaultTextFormatter.format(description, actual, expected);
    ...
    void testPrintWithActual() throws Exception {
        ...
        // when
        String result1 = defaultTextFormatter.format(message, actual);
        String result2 = defaultTextFormatter.format(description, actual);
    ...
    void testPrint() throws Exception {
        ...
        // when
        String result1 = defaultTextFormatter.format(message);
        String result2 = defaultTextFormatter.format(description);
